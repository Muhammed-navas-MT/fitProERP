...
const sidebarItems: SidebarItem[] = [
  ...
  { icon: <Calendar size={20} />, label: "Workout Plans", href: `${FRONTEND_ROUTES.MEMBER.BASE}/${FRONTEND_ROUTES.MEMBER.WORKOUT_PLAN}` },
  { icon: <Apple size={20} />, label: "Diet Plans", href: `${FRONTEND_ROUTES.MEMBER.BASE}/${FRONTEND_ROUTES.MEMBER.DIET_PLAN}` },
  { icon: <Calendar size={20} />, label: "Book Trainer", href: `${FRONTEND_ROUTES.MEMBER.BASE}/${FRONTEND_ROUTES.MEMBER.BOOK_TRAINER}` },
