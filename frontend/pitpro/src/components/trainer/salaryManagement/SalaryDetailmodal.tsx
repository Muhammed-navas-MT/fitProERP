...
export default function TrainerSalaryDetailModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[calc(100%-2rem)] max-h-[92vh] overflow-y-auto border border-[#1f1f1f] bg-gradient-to-br from-[#0f0f0f] via-[#141414] to-[#1a1a1a] p-0 text-zinc-100 shadow-2xl sm:max-w-5xl">
        <DialogHeader className="sticky top-0 z-10 border-b border-[#1f1f1f] bg-[#0f0f0f]/95 px-4 sm:px-6 py-4 backdrop-blur">
          <div className="flex flex-wrap items-start justify-between gap-3 sm:gap-4">
            <div className="min-w-0">
              <DialogTitle className="text-left text-xl sm:text-2xl font-semibold tracking-tight text-purple-400">
                Salary Detail
              </DialogTitle>
        ...
        <div className="p-4 sm:p-6">
          {isPendingState ? (
            ...
            <div className="space-y-6">
              <div className="group relative overflow-hidden rounded-xl border border-purple-500/20 bg-gradient-to-br from-[#1a1a1a] to-[#111111] p-4 sm:p-6 shadow-[0_0_20px_rgba(168,85,247,0.08)] transition-all hover:border-purple-500/40 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)]">
                ...
                <div className="relative">
                  ...
                  <div className="mt-2 flex flex-wrap items-baseline gap-2 sm:gap-3">
                    <span className="text-2xl sm:text-4xl font-bold tracking-tight text-white md:text-5xl break-all">
              ...
              <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-2">
                <div className="rounded-xl border border-[#2a2a2a] bg-[#1a1a1a]/80 p-4 sm:p-6 transition-colors hover:border-purple-500/30">
