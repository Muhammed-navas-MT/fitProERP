...
export function MembersSearch() {
  return (
    <div className="mb-6 rounded-lg border border-zinc-800 bg-zinc-900/50 p-4 lg:p-6">
      {/* Search Input */}
      <div className="mb-4 flex items-center gap-2 rounded-md border border-zinc-800 bg-black px-4 py-2.5">
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end">
        <div className="flex-1">
          ...
          <input
            type="date"
            className="w-full rounded-md border border-zinc-800 bg-black px-4 py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-orange-500"
          />
        </div>
        <div className="flex-1">
