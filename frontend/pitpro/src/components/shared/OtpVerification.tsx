...
export function OTPVerification({
  ...
  const theme = {
    ...
    card: "w-full max-w-md rounded-3xl border border-gray-800 bg-gradient-to-br from-gray-900 to-black p-8 shadow-2xl",
