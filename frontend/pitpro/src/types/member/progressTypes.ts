...
export function getBMICategoryBg(category: BMIStatus): string {
  switch (category) {
    case "Underweight": return "bg-info/10 border-info/20";
    case "Normal": return "bg-success/10 border-success/20";
    case "Overweight": return "bg-warning/10 border-warning/20";
    case "Obese": return "bg-destructive/10 border-destructive/20";
  }
}
