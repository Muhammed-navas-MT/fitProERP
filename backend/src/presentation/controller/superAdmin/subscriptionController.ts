...
export class SubscriptionController {
  constructor(
    ...
    private _listActiveSubscriptionUseCase: IListAllActiveSubscriptionUseCase,
  ) {}
  ...
  async listAllActiveSubscription(
    req: Request,
    res: Response,
    next: NextFunction,
  ) {
    try {
      const subscriptions =
        await this._listActiveSubscriptionUseCase.listAllSubscription();
      ResponseHelper.success(
        HTTP_STATUS_CODE.OK,
        res,
