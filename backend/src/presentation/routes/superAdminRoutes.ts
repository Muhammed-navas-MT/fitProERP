...
import {
  ...
  injectedSuperAdminController,
} from "../../infrastructure/DI/superAdmin/superAdminInjection";
...
export class SuperAdminRoutes {
  ...
  private _setRoute() {
    ...
    this._route.get(
      ROUTES.GYMADMIN.LISTSUBSCRIPTION,
      (req: Request, res: Response, next: NextFunction) => {
        injectedSubscriptionController.listAllActiveSubscription(
          req,
          res,
          next,
        );
    ...
    this._route.post(
      SUPERADMIN_AUTH.CREATE_SUBSCRIPTION,
      (req: Request, res: Response, next: NextFunction) => {
    ...
    this._route.put(
      SUPERADMIN_AUTH.BLOCK_SUBSCRIPTION,
      (req: Request, res: Response, next: NextFunction) => {
    ...
    this._route.put(
      SUPERADMIN_AUTH.UNBLOCK_SUBSCRIPTION,
      (req: Request, res: Response, next: NextFunction) => {
    ...
    this._route.get(
      SUPERADMIN_AUTH.FIND_SUBSCRIPTION,
      (req: Request, res: Response, next: NextFunction) => {
    ...
    this._route.put(
      SUPERADMIN_AUTH.UPDATE_SUBSCRIPTION,
      (req: Request, res: Response, next: NextFunction) => {
    ...
    this._route.get(
      SUPERADMIN_AUTH.LIST_SUBSCRIPTION,
      (req: Request, res: Response, next: NextFunction) => {
    ...
    this._route.get(
      SUPERADMIN_AUTH.LIST_PAYMENTS,
      (req: Request, res: Response, next: NextFunction) => {
        injectedPaymentController.listAllPayments(req, res, next);
      },
    );
